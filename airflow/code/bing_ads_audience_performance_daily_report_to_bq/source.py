...
bq_dataset = 'ads_msft'
bq_table = 'audience_performance_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "audience_id": int(row.get("AudienceId")) if row.get("AudienceId") else None,
...
dag = DAG(
    dag_id='bing_ads_audience_performance_daily_report_to_bq',
    schedule='15 0 * * *',
