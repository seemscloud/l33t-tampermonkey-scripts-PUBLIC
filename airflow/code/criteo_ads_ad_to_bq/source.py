...
def get_criteo_data_to_local():
    ...
    for advertiser_id in advertiser_ids:
        url = f"https://api.criteo.com/2024-07/marketing-solutions/advertisers/{advertiser_id}/ads"
        response = requests.get(
            url=url,
            headers=header,
        )
    ...
    if data:
        for row in data:
            ...
            df_row_data = {
                ...
                "ad_set_id": attribute_data.get('adSetId'),
                "creative_id": attribute_data.get('creativeId'),
            }
