...
bq_table = 'adset_statistics_report'
...
def get_criteo_data_to_local():
    ...
    payload = json.dumps({
        ...
        "endDate": yesterday,
        "format": "json",
        "dimensions": ["AdsetId", "Day", "CategoryId", "AdvertiserId"],
...
def remove_old_data():
    query = f'DELETE {GCPConnectionInfo.gcp_project}.{bq_dataset}.{bq_table} WHERE day >= "{last_30_day_ago}"'
...
dag = DAG(
    dag_id='criteo_ads_adset_statistics_report_to_bq',
    schedule='15 */6 * * *',
