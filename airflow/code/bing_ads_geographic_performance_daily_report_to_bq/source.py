"""
    https://learn.microsoft.com/en-us/advertising/reporting-service/geographicperformancereportrequest?view=bingads-13&tabs=json
"""
...
bq_dataset = 'ads_msft'
bq_table = 'geographic_performance_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "absolute_top_impression_rate_percent": row.get("AbsoluteTopImpressionRatePercent"),
                ...
                "metro_area": row.get("MetroArea"),
                "most_specific_location": row.get("MostSpecificLocation"),
                ...
                "spend": row.get("Spend"),
                "state": row.get("State"),
                "top_impression_rate_percent": row.get("TopImpressionRatePercent"),
        ...
        df = df.replace(r'\r+|\n+|\t+', '', regex=True)
        df['ad_group_id'] = df['ad_group_id'].astype('float').astype('Int64')
...
dag = DAG(
    dag_id='bing_ads_geographic_performance_daily_report_to_bq',
    schedule='15 0 * * *',
...
gcs_data_to_bq = GCSToBigQueryOperator(
    ...
    schema_fields=[
        ...
        {
            "name": "absolute_top_impression_rate_percent",
            "mode": "NULLABLE",
            "type": "FLOAT",
        },
        {
        ...
        {
            "name": "top_impression_rate_percent",
            "mode": "NULLABLE",
            "type": "FLOAT",
        },
        {
