"""
    https://learn.microsoft.com/en-us/advertising/reporting-service/agegenderaudiencereportrequest?view=bingads-13&tabs=json
"""
...
bq_dataset = 'ads_msft'
bq_table = 'age_gender_audience_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "extended_cost": row.get("ExtendedCost"),
...
dag = DAG(
    dag_id='bing_ads_age_gender_audience_daily_report_to_bq',
    schedule='15 0 * * *',
