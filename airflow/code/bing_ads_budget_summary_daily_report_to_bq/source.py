"""
    https://learn.microsoft.com/en-us/advertising/reporting-service/budgetsummaryreportrequest?view=bingads-13&tabs=json
"""
...
bq_dataset = 'ads_msft'
bq_table = 'budget_summary_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "daily_spend": row.get("DailySpend"),
                "month_to_date_spend": row.get("MonthToDateSpend"),
                "monthly_budget": row.get("MonthlyBudget"),
            }
...
dag = DAG(
    dag_id='bing_ads_budget_summary_daily_report_to_bq',
    schedule='15 0 * * *',
