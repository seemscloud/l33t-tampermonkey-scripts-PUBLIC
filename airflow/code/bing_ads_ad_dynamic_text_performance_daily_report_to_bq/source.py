"""
    https://learn.microsoft.com/en-us/advertising/reporting-service/addynamictextperformancereportrequest?view=bingads-13&tabs=json
"""
...
bq_dataset = 'ads_msft'
bq_table = 'ad_dynamic_text_performance_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "ad_description": row.get("AdDescription"),
                "ad_description_2": row.get("AdDescription2"),
                ...
                "ad_id": row.get("AdId"),
                "ad_labels": row.get("AdLabels"),
                "ad_status": row.get("AdStatus"),
                "ad_type": row.get("AdType"),
                ...
                "path_1": row.get("Path1"),
                "path_2": row.get("Path2"),
                "spend": row.get("Spend"),
                "title_part_1": row.get("TitlePart1"),
                "title_part_2": row.get("TitlePart2"),
                "title_part_3": row.get("TitlePart3"),
...
dag = DAG(
    dag_id='bing_ads_ad_dynamic_text_performance_daily_report_to_bq',
    schedule='15 0 * * *',
...
if __name__ == "__main__":
    get_bing_ads_report_request_id()
