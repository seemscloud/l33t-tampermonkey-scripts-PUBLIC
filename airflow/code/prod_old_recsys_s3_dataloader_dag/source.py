...
REMOTE_HOST_MACHINE_SSH_CONNECTION = "ssh_recsys_old_prod_connection"
...
with DAG(
    "prod_old_recsys_s3_dataloader_dag",
    default_args={
    ...
    (start >> start_compute_cloud >> clone_project >> create_env_file >> start_docker >> fetch_data >> stop_docker)
