...
with DAG(
   ...
   #     "on_failure_callback": create_telegram_alert_func(TELEGRAM_TOKEN_BOT),
    ...
    build_emptysearch = create_python_in_docker_ssh_command(
        task_id="build_emptysearch",
        command="python -m vvrecsys.cli.production --config=configs/production/emptysearch.yaml",
        docker_container_name=docker_container_name,
