"""
    https://learn.microsoft.com/en-us/advertising/reporting-service/destinationurlperformancereportrequest?view=bingads-13&tabs=json
"""
...
bq_dataset = 'ads_msft'
bq_table = 'destination_url_performance_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "final_url_suffix": row.get("FinalUrlSuffix"),
            }
...
dag = DAG(
    dag_id='bing_ads_destination_url_performance_daily_report_to_bq',
    schedule='15 0 * * *',
