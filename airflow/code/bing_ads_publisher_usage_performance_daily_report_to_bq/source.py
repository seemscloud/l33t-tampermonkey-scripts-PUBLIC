"""
    https://learn.microsoft.com/en-us/advertising/reporting-service/publisherusageperformancereportrequest?view=bingads-13&tabs=json
"""
...
bq_dataset = 'ads_msft'
bq_table = 'publisher_usage_performance_daily_report'
    ...
    if raw_data:
        for row in raw_data:
            df_row_data = {
                ...
                "ad_group_id": row.get("AdGroupId", None),
                ...
                "publisher_url": row.get("PublisherUrl"),
        ...
        df = df.replace(r'\r+|\n+|\t+', '', regex=True)
        df['ad_group_id'] = df['ad_group_id'].astype('Int64')
...
dag = DAG(
    dag_id='bing_ads_publisher_usage_performance_daily_report_to_bq',
    schedule='15 0 * * *',
